...
export const filipino: Record<string, string> = {
  ...
  'Unsaved entries from your last visit were restored.': 'Naibalik ang mga hindi pa naisasave mula sa huling pagbisita.',
  'Start blank': 'Magsimulang blangko',
  'Sign in needed:': 'Kailangang mag-sign in:',
  'This device was signed out. Records already saved here stay on the phone and sync once you are back in.': 'Na-sign out ang device na ito. Nananatili sa telepono ang mga naitalang tala at magsi-sync kapag naka-sign in ka na ulit.',
  'Sign in again': 'Mag-sign in ulit',
  'Remove': 'Alisin',
  'Remove this member?': 'Alisin ang miyembrong ito?',
  'what was typed for this member will be discarded.': 'mawawala ang mga naitala para sa miyembrong ito.',
  'Keep member': 'Panatilihin',
